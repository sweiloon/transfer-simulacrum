  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 relative">
          ...
          <div className="px-6 py-4 flex items-center justify-between">
            <div>
              <div className="text-gray-700" style={{ fontSize: "16px" }}>
                Transfer From{" "}
                <span className="font-bold">Savings Account-i</span>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <span className="text-gray-600 text-sm">Available Balance</span>
              <span className="text-teal-600 text-sm">RM 232,047.58</span>
            </div>
          </div>
        </div>
        ...
        {/* Transfer To Section */}
        <div
          className="rounded-lg shadow-sm border border-gray-200 mb-0"
          ...
          <div className="p-6">
            <div className="flex items-start justify-between mb-2">
              <div>
                ...
                <div className="text-sm mt-1" style={{ color: "#474747" }}>
              ...
              >
                <img
                  src="/lovable-uploads/ca336a31-0e33-4d87-9dbc-e6a991f00a42.png"
                  alt="Edit"
                  className="w-7 h-7"
                />
              </Button>
          ...
          <div className="p-6 bg-white rounded-b-lg">
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-gray-500 text-sm">
                  Today{" "}
                  {new Date(transferData.effectiveDate).toLocaleDateString(
                    "en-GB",
                    {
                      day: "2-digit",
                      month: "short",
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-16 mt-2">
          <div className="px-6 py-4 flex items-center justify-between">
            <div className="text-sm font-normal" style={{ color: "#474747" }}>
              Total Amount
            </div>
            <div className="text-sm" style={{ color: "#D9332D" }}>
              {formatCurrency(transferData.amount)}
            </div>
          </div>
        </div>
